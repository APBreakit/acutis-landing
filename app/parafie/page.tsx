...
export default function ParafiePage() {
  ...
  const features = [
    {
      ...
      description: "Pełny kalendarz liturgiczny z intencjami mszalnymi i wydarzeniami parafialnymi",
    },
    {
      icon: "📖",
      title: "Sakramenty Online",
      description: "Zgłoszenia do sakramentów: chrztów, bierzmowań, ślubów - wszystko online",
    },
    {
      icon: "💒",
      title: "Transmisje Mszy",
      description: "Integracja z YouTube/Facebook dla transmisji mszy świętych na żywo",
    },
    {
      icon: "📝",
      title: "Ogłoszenia Parafialne",
      description: "System zarządzania ogłoszeniami parafialnymi i aktualnościami",
    },
    {
      icon: "👥",
      title: "Wspólnoty i Grupy",
      description: "Prezentacja wspólnot parafialnych, ministrantów, chórów i grup modlitewnych",
    },
    {
      icon: "💳",
      title: "Darowizny Online",
      description: "Bezpieczny system przyjmowania darowizn i ofiar parafialnych",
    },
  ]

  const examples = [
    {
      title: "Parafia Św. Jana",
      description: "Nowoczesna strona z transmisją online",
      image: "/parish-website.jpg",
    },
    {
      title: "Parafia MB Częstochowskiej",
      description: "Portal z systemem zapisu do sakramentów",
      image: "/grand-church-interior.png",
    },
    {
      title: "Parafia NMP Królowej Polski",
      description: "Strona z kalendarzem i biblioteką multimedialną",
      image: "/catholic-church-altar.jpg",
    },
  ]
      ...
      <section className="relative z-10 container mx-auto px-4 sm:px-6 pt-32 pb-20">
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-br from-[#FEFAF6] via-[#EADBC8] to-[#DAC0A3] bg-clip-text text-transparent">
            Strony dla Parafii i Kościołów
          </h1>
          <p className="text-xl text-[#EADBC8] mb-8">
            Profesjonalne strony internetowe dla wspólnot parafialnych z transmisją online, kalendarzem liturgicznym i
            systemem zapisu do sakramentów
          </p>
          <Link
            href="/#wycena"
        ...
        <div className="mb-20">
          <h2 className="text-4xl font-bold text-[#FEFAF6] text-center mb-12">Przykładowe Realizacje</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {examples.map((example, i) => (
              <div
                key={i}
                className="backdrop-blur-xl rounded-2xl overflow-hidden transition-all duration-500 hover:scale-105"
                style={{
                  background: "rgba(254, 250, 246, 0.08)",
                  border: "1px solid rgba(218, 192, 163, 0.25)",
                }}
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-[#FEFAF6] mb-2">{example.title}</h3>
                  <p className="text-sm text-[#EADBC8]">{example.description}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        >
          <h2 className="text-4xl font-bold text-[#FEFAF6] mb-6">Gotowi na Nowoczesną Stronę Parafialną?</h2>
          <p className="text-xl text-[#EADBC8] mb-8">
            Skontaktuj się z nami i otrzymaj bezpłatną wycenę dostosowaną do potrzeb Twojej parafii
          </p>
          <Link
            href="/#kontakt"
