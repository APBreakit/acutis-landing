      ...
      <main className="relative z-10 pb-24">
        ...
        <section className="container mx-auto px-6 pt-16 pb-12">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6" style={{ background: 'rgba(218, 192, 163, 0.15)' }}>
            ...
            <p className="text-lg text-[#EADBC8] leading-relaxed">
              Poznaj kamienie milowe rozwoju Acutis, zobacz co planujemy w kolejnych wydaniach oraz sprawdź, na jakich platformach możesz korzystać z systemu już dziś.
            </p>
          </div>
        </section>
        ...
        <section className="container mx-auto px-6 pb-16">
          <div className="backdrop-blur-xl rounded-3xl p-10" style={{ background: 'rgba(254, 250, 246, 0.06)', border: '1px solid rgba(218, 192, 163, 0.2)' }}>
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
              <div>
                ...
                <p className="text-[#EADBC8] text-sm md:text-base max-w-xl">
                  Acutis wspiera najpopularniejsze systemy operacyjne. Wersje desktopowe są zoptymalizowane do pracy w kancelarii, a wersja webowa zapewnia dostęp z każdego miejsca.
                </p>
              </div>
              <Link
                href="/"
              ...
              {platforms.map((platform) => (
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    <div className="relative w-14 h-14 flex items-center justify-center rounded-full" style={{ background: 'rgba(218, 192, 163, 0.2)' }}>
                      <Image
                  ...
                  {platform.available ? (
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-semibold text-[#DAC0A3]" style={{ background: 'rgba(254, 250, 246, 0.08)', border: '1px dashed rgba(218, 192, 163, 0.4)' }}>
              ...
              <div className="space-y-10">
                {betaTimeline.map((entry) => (
                  <div
                    ...
                    className="relative"
                  >
                    <div className="absolute -left-[42px] top-2 w-8 h-8 rounded-full flex items-center justify-center"
                      style={{ background: 'linear-gradient(135deg, #DAC0A3 0%, #EADBC8 100%)' }}
                    >
                      <span className="text-lg">🚀</span>
                    </div>
                    <div className="backdrop-blur-xl rounded-2xl p-6 border border-white/10" style={{ background: 'rgba(254, 250, 246, 0.08)' }}>
                      <div className="flex flex-wrap items-center gap-3 mb-3">
                        ...
                        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${statusPillStyles[entry.statusTone]}`}>
                          {entry.status}
                        </span>
                      </div>
        ...
        <section className="container mx-auto px-6 pb-16">
          <div className="max-w-5xl">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {roadmap.map((item) => (
                <div key={item.id} className="backdrop-blur-xl rounded-2xl p-6 border border-white/10" style={{ background: 'rgba(254, 250, 246, 0.08)' }}>
