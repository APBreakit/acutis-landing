    ...
    >
      ...
      <section id="hero" className="relative z-10 container mx-auto px-4 sm:px-6 pt-24 sm:pt-32 pb-12 sm:pb-20">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 bg-gradient-to-br from-[#FEFAF6] via-[#EADBC8] to-[#DAC0A3] bg-clip-text text-transparent animate-slide-up drop-shadow-2xl leading-tight">
