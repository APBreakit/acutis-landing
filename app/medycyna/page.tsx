...
export default function MedycynaPage() {
  ...
  const features = [
    {
      ...
      description: "Profesjonalna strona dla gabinetu lekarskiego lub kliniki",
    },
    {
      icon: "📅",
      title: "Rezerwacje Online",
      description: "System rezerwacji wizyt lekarskich przez Internet 24/7",
    },
    {
      icon: "💊",
      title: "Katalog Usług",
      description: "Prezentacja usług medycznych z cenami i opisami zabiegów",
    },
    {
      icon: "👨‍⚕️",
      title: "Zespół Medyczny",
      description: "Prezentacja lekarzy z doświadczeniem i specjalizacjami",
    },
    {
      icon: "🔒",
      title: "RODO i Bezpieczeństwo",
      description: "Pełna zgodność z wymogami ochrony danych medycznych",
    },
    {
      icon: "📱",
      title: "Telemedycyna",
      description: "Integracja z platformami telekonsultacji i e-recept",
    },
  ]
      ...
      <section className="relative z-10 container mx-auto px-4 sm:px-6 pt-32 pb-20">
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-br from-[#FEFAF6] via-[#EADBC8] to-[#DAC0A3] bg-clip-text text-transparent">
            Strony dla Gabinetów i Klinik
          </h1>
          <p className="text-xl text-[#EADBC8] mb-8">
            Profesjonalne strony dla placówek medycznych z systemem rezerwacji wizyt, katalogiem usług i pełną
            zgodnością z RODO
          </p>
          <Link
            href="/#wycena"
        ...
        >
          <h2 className="text-4xl font-bold text-[#FEFAF6] mb-6">Zmodernizuj Swój Gabinet Cyfrowo</h2>
          <p className="text-xl text-[#EADBC8] mb-8">
            Ułatw pacjentom umówienie wizyty i zwiększ efektywność swojej praktyki
          </p>
          <Link
            href="/#kontakt"
