  ...
  const features = [
    {
      ...
      description: "Kompleksowy sklep online z pełnym systemem zarządzania produktami",
    },
    {
      icon: "💳",
      title: "Płatności Online",
      description: "Integracja z Stripe, PayU, Przelewy24 i innymi bramkami płatności",
    },
    {
      icon: "📦",
      title: "Zarządzanie Wysyłką",
      description: "Automatyzacja procesu wysyłki z integracją kurierów",
    },
    {
      icon: "🎯",
      title: "Marketing AI",
      description: "Automatyczne rekomendacje produktów i personalizacja oferty",
    },
    {
      icon: "📊",
      title: "Analytics",
      description: "Szczegółowa analityka sprzedaży i zachowań klientów",
    },
    {
      icon: "📱",
      title: "Mobile Commerce",
      description: "W pełni responsywny sklep zoptymalizowany pod urządzenia mobilne",
    },
  ]
      ...
      <section className="relative z-10 container mx-auto px-4 sm:px-6 pt-32 pb-20">
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <p className="text-xl text-[#EADBC8] mb-8">
            Profesjonalne sklepy internetowe z integracją płatności, zarządzaniem produktami i zaawansowaną analityką.
            Sprzedawaj więcej z AI
          </p>
          <Link
            href="/#wycena"
        ...
        >
          <h2 className="text-4xl font-bold text-[#FEFAF6] mb-6">Rozpocznij Sprzedaż Online</h2>
          <p className="text-xl text-[#EADBC8] mb-8">
            Stwórz profesjonalny sklep internetowy i zacznij sprzedawać już dziś
          </p>
          <Link
            href="/#kontakt"
